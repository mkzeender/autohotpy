...
from autohotpy.ahk_instance import AhkState, AhkInstance
import signal
from ctypes import windll

from autohotpy.ahk_object import AhkScript
...
def ahk_runstr(*script: str, wait_for: AhkState | None = AhkState.IDLE) -> AhkScript:
    if thread_state.current_instance is None:
        ...
        thread_state.current_instance.add_script(*script, wait_for=wait_for)
